...
const AvatarForms: FC<Props> = ({ repository, avatarType, icon, setIcon, color, setColor, file, setFile }) => {
  ...
  const [autoGeneratedColor, setAutoGeneratedColor] = useState("");
        ...
        <AvatarPreview
          avatar={
            <AutoGeneratedAvatar
              ...
              setColor={setAutoGeneratedColor}
              setIcon={setAutoGeneratedName}
            />
          }
          color={autoGeneratedColor}
  ...
  return (
    <Wrapper className="is-clipped" aria-live="polite">
      {avatar}
    </Wrapper>
  );
};
